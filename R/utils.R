...
# #' the environment variable `openalexPro.apikey` if set; otherwise it falls back
# #' to the R option `openalexPro.apikey`. If neither is defined, `NULL` is
# #' returned.
# #'
...
# #'
# #' # Or via options
# #' options(openalexPro.apikey = "<api-key>")
# #' oap_apikey()
# #'
...
# #' @export
# oap_apikey <- function() {
#   apikey <- Sys.getenv("openalexPro.apikey")
#   if (apikey == "") {
#     apikey <- getOption("openalexPro.apikey", default = NULL)
#   }
#   apikey
# }
