...
#'    - **`outside`**: only  edges where either the `from` or the `to` is not in `nodes`
...
#' @param shorten_ids If `TRUE` the ids will be shortened, i.e. the part `https://openalex.org/` will be removed
#'
